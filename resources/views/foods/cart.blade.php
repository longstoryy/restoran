        ...
        <table class="table">
            ...
            <tbody>
                @if($cartItems->count() > 0)
                    ...
                    @endforeach
                @else
                    <h2 class="alert alert-success">you have no items in cart yet</h2>
          ...
          <div class="position-relative mx-auto" style="max-width: 400px; padding-left: 679px;">
            ...
            @if($price == 0)
                <p style="width: 241px"  class="alert alert-success">There is no items in your cart,please check out </p>
            @else
